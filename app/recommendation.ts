import {KATAS,highestNumericGrade,sortGrades,type Grade,type Kata,type NumericGrade} from "./data";
...
export function recommend(grades:Grade[],count:number,logs:RecommendationLog[],avoidNames=new Set<string>(),mode:GradeMode="balanced"):Kata[]{
 ...
 const selected=sortGrades(grades),participantWeight=(grade:Grade)=>selected.length===1?1:mode==="highest"?(grade===highest?2.5:0.65):1;
